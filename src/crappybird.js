...
/*
TODO: 
    * sort this file out into multiple logical files
    * set the course - the pipes mustn't be different hights every time the game runs
*/
...
//sounds
var soundJump = new Audio("data/audio/wing.ogg");
var soundScore = new Audio("data/audio/point.ogg");
var soundHit = new Audio("data/audio/hit.ogg");
var soundDie = new Audio("data/audio/die.ogg");
var soundSwoosh = new Audio("data/audio/swooshing.ogg");
...
FB.Bird = function () {
    ...
    this.img = new Image();
    this.img.src = 'data/images/bird.png';
    this.gravity = 0.25;
    this.width = 34;
    this.height = 24;
    this.ix = 0;
...
window.Splash = function () {
    ...
    this.banner.src = "data/images/splash.png";
...
window.Play = function () {
    ...
    this.init = function () {
        ...
        for (var n = 0; n < 10; n++) {
            var img = new Image();
            img.src = "data/images/font_small_" + n + '.png';
            FB.fonts.push(img);
        }
        FB.digits = ["0"];
    }
...
window.GameOver = function () {
    ...
    this.init = function () {
        ...
        setTimeout(function () {
            ...
            that.banner.src = "data/images/scoreboard.png";
            var m = that.getMedal();
            that.medal = new Image();
            that.medal.src = 'data/images/medal_' + m + '.png';
            that.replay = new Image();
            that.replay.src = "data/images/replay.png";
